#!/usr/bin/env python3
"""
Test V2 storage abstraction layer
"""
...
from storage import BookStorage, StorageConfig, StorageNotFoundError
...
async def test_integration_example():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # This shows how download_single.py could be modified to use V2 storage
        print("✅ Integration example complete\n")


async def main():
    """Run all storage tests."""
    print("V2 Storage Abstraction Tests")
    print("=" * 40)
