...
echo "  Auth setup:      python grin.py auth setup"
echo "  Test suite:      pytest src/tests/"
echo "  Book collection: python grin.py collect --help"
echo "  Processing:      python grin.py process --help"
echo "  Sync pipeline:   python grin.py sync pipeline --queue converted --help"
echo "  Sync status:     python grin.py sync status --help"
echo "  Storage mgmt:    python grin.py storage --help"
echo "  Enrichment:      python grin.py enrich --help"
echo "  Export CSV:      python grin.py export-csv --help"
echo "  Status:          python grin.py status --help"
echo ""
