...
if TYPE_CHECKING:
    ...
    from grin_transfer.sync.tasks.task_types import StagingCleanupResult
...
async def run_staging_cleanup(pipeline: "SyncPipeline") -> "StagingCleanupResult":
    ...
    from grin_transfer.sync.tasks.task_types import Result, StagingCleanupData, TaskAction, TaskType
