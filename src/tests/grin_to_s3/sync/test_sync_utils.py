...
class TestETagOperations:
    ...
    async def test_check_encrypted_etag_success(self, mock_grin_client):
        ...
        with patch("grin_to_s3.common.create_http_session") as mock_session:
            ...
            etag, file_size, status_code = await check_encrypted_etag(mock_grin_client, "Harvard", "TEST123")
    ...
    async def test_check_encrypted_etag_error(self, mock_grin_client):
        ...
        with patch("grin_to_s3.common.create_http_session") as mock_session:
            ...
            with pytest.raises(Exception, match="Network error"):
                await check_encrypted_etag(mock_grin_client, "Harvard", "TEST123")

    @pytest.mark.asyncio
    async def test_check_encrypted_etag_404_error(self, mock_grin_client):
