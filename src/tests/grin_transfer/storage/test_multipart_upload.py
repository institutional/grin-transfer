...
from grin_transfer.storage.base import BackendConfig, Storage, UploadPartTimeoutError
...
async def test_multipart_upload_producer_failure_aborts(monkeypatch: pytest.MonkeyPatch, tmp_path) -> None:
    ...
    monkeypatch.setattr("grin_transfer.storage.base.aiofiles.open", fake_open)
