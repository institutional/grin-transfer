...
from grin_transfer.collect_books.collector import BookCollector, RateLimiter
...
class TestBookCollector:
    ...
    async def test_process_book_logs_warning_when_download_should_be_available(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="grin_transfer.collect_books.collector"):
...
class TestBookCollectionIntegration:
    ...
    def test_book_collector_with_storage_initialization(self, mock_process_stage):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            from grin_transfer.run_config import RunConfig, SyncConfig
