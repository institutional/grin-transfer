...
from grin_transfer.database import connect_async
from grin_transfer.sync.db_updates import (
    UPDATE_HANDLERS,
...
from grin_transfer.sync.task_manager import TaskManager
from grin_transfer.sync.tasks.task_types import RequestConversionResult, TaskAction, TaskResult, TaskType
...
class TestRealDatabaseIntegration:
    ...
    async def _apply_updates_to_pipeline(self, pipeline, updates, barcode="TEST123"):
        ...
        from grin_transfer.sync.db_updates import StatusUpdate
